...
const NavbarComponent = () => {
  ...
  const { full_name, user_type } = useSelector((state) => state.auth);
          ...
          <div className="container">
            ...
            <div className="collapse navbar-collapse" id="navbarSupportedContent">
              <ul className="navbar-nav ms-auto mb-2 mb-lg-0">
                ...
                <li className="nav-item">
                  <NavLink className="nav-link" to='/notifications' tag={Link}>
                    Notifications
                  </NavLink>
                </li>
                <li className="nav-item">
                ...
                <div className="d-flex flex-row justify-content-between">
                  ...
                  <div className="dropdown" onClick={toggleDropdown}>
                    ...
                    >
                      ...
                      <li className="mt-3">
                        <Link className="dropdown-item d-flex align-items-center" to="/my_reservations">My Reservation</Link>
                      </li>
                      <li className="mt-3">
                      ...
                      <li className="mt-3">
                        <Link className="dropdown-item d-flex align-items-center" to="/help_center">Help Center</Link>
                      </li>
