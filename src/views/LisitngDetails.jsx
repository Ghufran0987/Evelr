...
// import { getPostById } from '../redux-store/features/post/postSlice';

// const ListingDetails = () => {
//   const { id } = useParams();
//   const { postDetails, isPostLoading, error } = useSelector((state) => state.post);
...
//                 <img src={map} style={{ height: '100%', width: '100%' }} alt="map-location" />
//               </div>
          ...
          <div className="row">
            ...
            >
              <div className="d-flex align-items-center justify-content-between">
                ...
                <div>
                  <button className="primary-button row_btns" onClick={onBooking}>Book Now</button>
                </div>
              </div>
              <h3 style={{ marginTop: '50px', fontSize: '30px', fontWeight: '600' }}>Select Check In Date</h3>
              <p style={{ marginTop: '0px', fontSize: '22px', fontWeight: '500' }}>Add your dates for exact pricing</p>
